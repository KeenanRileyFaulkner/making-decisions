...
if(temperature >= 80) {
  ...
  if(rain) {
    ...
    console.log("Wear a t-shirt. It's a beautiful day outside!");
  }
} else if(temperature > 60) {
  if(rain) {
    console.log("Wear a rain jacket.");
  } else {
    console.log("It's a little breezy outside. You might want to wear long sleeves.");
  }
} else {
  console.log("Wear a jacket and don't forget your umbrella! It's really cold!");
}
